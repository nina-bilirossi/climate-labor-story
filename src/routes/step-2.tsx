          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>Existing work establishes the structural drivers of informality \citep{Ulyssea2020, LaPorta2014} and labor market transitions in India \citep{Abraham2025}, but largely omits an environmental dimension</li>
                ...
                <li>Tests two competing mechanisms: (1) informal firms' smaller size/lower capital \citep{Jat2026} may make them more fragile to climate shocks, reducing informality as they collapse; or (2) informal work's flexibility and low fixed costs may insulate it from shocks, shifting the burden onto formal employment</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>Prior work documents the macroeconomic costs of floods/droughts in India \citep{Panwar2020, Bahinipati2026} and the migration they induce \citep{Ulyssea2026}</li>
                <li>Along with \citet{LintBarrage2026} on informality, climate policy, and hurricanes, this paper provides state-level evidence that different types of climatic exposure directly reshape the formal-informal composition of the labor force, treating informality as an outcome in its own right rather than a background condition</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>India's labor market is already structurally fragile — pervasive informality/self-employment, rising fragmentation, low female labor force participation, marginalization of large social groups \citep{Hammer2022}</li>
                <li>Existing labor protections can backfire: \citet{Chaurey2024} finds new employment protection legislation in Andhra Pradesh reduced formal contract work while expanding lower-wage informal employment, depressing aggregate productivity and welfare</li>
                <li>Climate shocks' poverty consequences are most severe where economies are agriculture-dependent and institutions are weak, though diversification and strong governance can attenuate effects \citep{Behera2025}</li>
                <li>This challenge is further complicated by the ambiguity inherent in climate adaptation decision-making \citep{YanSims2025}</li>
