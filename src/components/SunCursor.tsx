...
export function SunCursor() {
  ...
  const size = hot ? 28 : 14;
  const opacity = hot ? 0.95 : 0.75;
    ...
    <div
      ...
      style={{
        ...
        background: hot
          ...
          : "radial-gradient(circle at 50% 50%, oklch(0.92 0.14 90 / 0.85) 0%, oklch(0.88 0.14 80 / 0.45) 45%, oklch(0.85 0.16 75 / 0) 70%)",
        boxShadow: hot
          ? "0 0 12px 4px oklch(0.93 0.19 88 / 0.75), 0 0 28px 10px oklch(0.9 0.18 82 / 0.45)"
          : "0 0 6px 2px oklch(0.9 0.15 85 / 0.4), 0 0 16px 5px oklch(0.88 0.14 80 / 0.22)",
        mixBlendMode: "screen",
      }}
    />
  );
