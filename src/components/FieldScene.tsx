 ...
 * with a small hut beside them. Three interactive hotspots with tooltips
 * link to dedicated context pages.
 */
      ...
      >
        ...
        >
          <g>
            ...
            {/* Cloud */}
            <g
              className="transition-transform duration-500 group-hover:translate-x-[-4px]"
          ...
          <title>more about the climate shocks</title>
        </Link>
        ...
        <Link to="/labor-history" className="group cursor-pointer outline-none">
          ...
          <title>more about indian labor force and informality history</title>
        </Link>
        ...
        <Link to="/informality-context" className="group cursor-pointer outline-none">
          ...
          <title>more about informality</title>
        </Link>
