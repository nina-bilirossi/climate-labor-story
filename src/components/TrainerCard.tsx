import ninaPhoto from "@/assets/nina-hiking.jpeg.asset.json";
  ...
  return (
    <div className="not-prose w-full max-w-[240px] text-xs flex">
      <div className="relative flex w-full flex-col rounded-xl border-2 border-[color:var(--sun)] bg-gradient-to-br from-amber-50 to-orange-100 p-3 shadow-[0_4px_0_rgba(0,0,0,0.12),0_8px_20px_rgba(0,0,0,0.18)] dark:from-amber-950/40 dark:to-orange-950/40">
        ...
        {/* Portrait */}
        <div className="mx-auto mt-2 h-24 w-24 overflow-hidden rounded-lg border-2 border-foreground/20 bg-gradient-to-br from-sky-200 via-emerald-100 to-amber-100 dark:from-sky-900/50 dark:via-emerald-900/40 dark:to-amber-900/40">
          <img
            src={ninaPhoto.url}
